...
import { autoPartService } from '../services/autoPartService'; // Reuse upload logic
import { Card } from '../components/ui/Card';
import Input from '../components/Input';
import { API_BASE_URL } from '../config/env';

export default function CreateAutoPartCategoryPage() {
    ...
    const handleFileSelect = async (e) => {
        ...
        setUploading(true);
        try {
            // Reusing autoPartService.uploadImages which returns string or array of strings
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-6">
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-2xl font-bold text-slate-900">{t('categories.newCategory')}</h1>
            ...
            <form onSubmit={handleSubmit} className="grid gap-6 lg:grid-cols-3">
                <div className="lg:col-span-2 space-y-6">
                    <Card className="p-6 space-y-6">
                        <h3 className="font-semibold text-slate-900">{t('dashboard.statistics')}</h3>
